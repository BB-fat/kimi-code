...
function tick(): Promise<void> {
  // MCP config resolution performs real fs IO (walks up to the project root,
  // reads *.mcp.json) which races a 0ms timer under suite-wide thread-pool
  // contention; a short delay keeps the ordering deterministic.
