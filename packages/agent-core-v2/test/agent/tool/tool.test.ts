  ...
  describe('registered user tools', () => {
    ...
    it('routes registered user tools through tool.call request/response', async () => {
      ...
      expect(
        ...
        [emit] agent.status.updated        { "rawContextTokens": 90 }
        ...
        [emit] agent.status.updated        { "rawContextTokens": 105 }
        ...
        [emit] agent.status.updated        { "rawContextTokens": 129 }
      ...
      expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
        ...
        [emit] agent.status.updated        { "rawContextTokens": 108 }
        ...
        [emit] agent.status.updated        { "rawContextTokens": 114 }
        ...
        [emit] agent.status.updated        { "contextTokens": 125 }
        ...
        [emit] agent.status.updated        { "rawContextTokens": 137 }
    ...
    `);
      ...
      expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
        ...
        [emit] agent.status.updated         { "contextTokens": 144 }
        ...
        [emit] agent.status.updated         { "rawContextTokens": 155 }
        ...
        [emit] agent.status.updated         { "rawContextTokens": 144 }
