...
describe('Agent loop', () => {
  ...
  it('runs a text-only agent turn from prompt to completion', async () => {
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [emit] agent.status.updated        { "rawContextTokens": 3 }
      ...
      [emit] agent.status.updated        { "rawContextTokens": 9 }
      ...
      [emit] agent.status.updated        { "rawContextTokens": 17 }
      ...
      [emit] agent.status.updated        { "rawContextTokens": 23 }
  ...
  it('runs an agent turn through registered tool approval and execution', async () => {
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [emit] agent.status.updated                { "rawContextTokens": 47 }
      ...
      [emit] agent.status.updated                { "rawContextTokens": 32 }
      ...
      [emit] agent.status.updated                { "rawContextTokens": 57 }
      ...
      [emit] agent.status.updated                { "rawContextTokens": 44 }
