...
describe('Agent loop', () => {
  ...
  it('runs a text-only agent turn from prompt to completion', async () => {
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [emit] agent.status.updated        { "contextTokens": 6, "rawContextTokens": 9 }
      ...
      [emit] agent.status.updated        { "contextTokens": 10, "rawContextTokens": 17 }
      ...
      [emit] agent.status.updated        { "contextTokens": 13, "rawContextTokens": 23 }
      ...
      [emit] agent.status.updated        { "contextTokens": 13, "rawContextTokens": 13 }
  ...
  it('fails the turn after a filtered step completes', async () => {
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [emit] agent.status.updated        { "contextTokens": 8, "rawContextTokens": 13 }
  ...
  it('runs an agent turn through registered tool approval and execution', async () => {
    ...
    expect(await ctx.untilApproval(true)).toMatchInlineSnapshot(`
      ...
      [emit] turn.step.started               { "turnId": 0, "step": 1, "stepId": "<uuid-1>" }
      [wire] context.append_loop_event       { "event": { "type": "step.begin", "uuid": "<uuid-1>", "turnId": "0", "step": 1 }, "time": "<time>" }
      [emit] agent.status.updated            { "contextTokens": 5, "rawContextTokens": 8 }
      ...
      [wire] llm.request                     { "kind": "loop", "provider": "kimi", "model": "mock-model", "modelAlias": "mock-model", "thinkingEffort": "off", "maxTokens": 999995, "toolSelect": false, "systemPromptHash": "ec9c34379c88babbc468ef2f3e0e08cd2f422c8c4a910664fb8bb394d703a575", "toolsHash": "3bfeb22e61431247933e79f6ab94e7ca14a127f899bc87e7bbd22594ba9cdb66", "messageCount": 1, "turnStep": "0.1", "time": "<time>" }
      ...
      [emit] agent.status.updated            { "contextTokens": 14, "rawContextTokens": 23 }
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [emit] agent.status.updated                { "contextTokens": 26, "rawContextTokens": 47 }
      ...
      [emit] agent.status.updated                { "contextTokens": 26, "rawContextTokens": 26 }
      ...
      [emit] agent.status.updated                { "contextTokens": 29, "rawContextTokens": 32 }
      ...
      [emit] agent.status.updated                { "contextTokens": 44, "rawContextTokens": 57 }
      ...
      [emit] agent.status.updated                { "contextTokens": 44, "rawContextTokens": 44 }
