...
describe('AgentSwarmTool', () => {
  ...
  it('advertises secondary/primary shortcuts when secondary is configured and catalog models otherwise', async () => {
    const host = mockSwarmHost();
    const configured = new AgentSwarmTool(host.swarmService, makeAgentScopeContext({ agentId: host.callerAgentId, agentScope: '' }), mockSwarmMode(), stubConfig({ model: 'provider/secondary' }), stubFlag(true), stubSwarmCatalog(), stubCallerProfile({ modelAlias: 'main-model' }), stubModels({ 'provider/secondary': { model: 'provider/secondary' } }), stubModelCatalog({
    ...
    const catalogOnly = new AgentSwarmTool(host.swarmService, makeAgentScopeContext({ agentId: host.callerAgentId, agentScope: '' }), mockSwarmMode(), stubConfig(), stubFlag(true), stubSwarmCatalog(), stubCallerProfile({ modelAlias: 'main-model' }), stubModels({ 'main-model': { model: 'main-model' } }), stubModelCatalog());
    ...
    const empty = new AgentSwarmTool(host.swarmService, makeAgentScopeContext({ agentId: host.callerAgentId, agentScope: '' }), mockSwarmMode(), stubConfig(), stubFlag(true), stubSwarmCatalog(), stubCallerProfile({ modelAlias: 'main-model' }), stubModels(), stubModelCatalog());
