  ...
  describe('plan allows safe tool flow', () => {
    ...
    it('allows read-only Bash to continue through permission and execution', async () => {
      ...
      expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
        ...
        [emit] agent.status.updated        { "contextTokens": 570, "rawContextTokens": 580 }
        ...
        [emit] agent.status.updated        { "contextTokens": 574, "rawContextTokens": 604 }
        ...
        [emit] agent.status.updated        { "contextTokens": 574, "rawContextTokens": 574 }
        ...
        [emit] agent.status.updated        { "contextTokens": 577, "rawContextTokens": 580 }
        [wire] llm.request                 { "kind": "loop", "provider": "kimi", "model": "mock-model", "modelAlias": "mock-model", "thinkingEffort": "off", "maxTokens": 999423, "toolSelect": false, "systemPromptHash": "ec9c34379c88babbc468ef2f3e0e08cd2f422c8c4a910664fb8bb394d703a575", "toolsHash": "aca3041121ee711028f726fed37e7b999f7e8885c05dbece76ef97eb43e2ec1e", "messageCount": 4, "turnStep": "0.2", "time": "<time>" }
        ...
        [emit] agent.status.updated        { "contextTokens": 587, "rawContextTokens": 600 }
        ...
        [emit] agent.status.updated        { "contextTokens": 587, "rawContextTokens": 587 }
  ...
  describe('plan mode Bash ordinary permission behavior', () => {
    it('allows Bash through ordinary yolo permission behavior', async () => {
      ...
      expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
        ...
        [emit] agent.status.updated        { "contextTokens": 568, "rawContextTokens": 577 }
        ...
        [emit] agent.status.updated        { "contextTokens": 571, "rawContextTokens": 600 }
        ...
        [emit] agent.status.updated        { "contextTokens": 571, "rawContextTokens": 571 }
        ...
        [emit] turn.step.started           { "turnId": 0, "step": 2, "stepId": "<uuid-4>" }
        [wire] context.append_loop_event   { "event": { "type": "step.begin", "uuid": "<uuid-4>", "turnId": "0", "step": 2 }, "time": "<time>" }
        [emit] agent.status.updated        { "contextTokens": 574, "rawContextTokens": 577 }
        [wire] llm.request                 { "kind": "loop", "provider": "kimi", "model": "mock-model", "modelAlias": "mock-model", "thinkingEffort": "off", "maxTokens": 999426, "toolSelect": false, "systemPromptHash": "ec9c34379c88babbc468ef2f3e0e08cd2f422c8c4a910664fb8bb394d703a575", "toolsHash": "aca3041121ee711028f726fed37e7b999f7e8885c05dbece76ef97eb43e2ec1e", "messageCount": 4, "turnStep": "0.2", "time": "<time>" }
        ...
        [emit] agent.status.updated        { "contextTokens": 581, "rawContextTokens": 591 }
        ...
        [emit] agent.status.updated        { "contextTokens": 581, "rawContextTokens": 581 }
