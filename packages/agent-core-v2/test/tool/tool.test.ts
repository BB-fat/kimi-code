  ...
  describe('registered user tools', () => {
    ...
    it('routes registered user tools through tool.call request/response', async () => {
      ...
      expect(
        ...
        [emit] agent.status.updated        { "contextTokens": 161, "rawContextTokens": 170 }
        ...
        [emit] agent.status.updated        { "contextTokens": 161, "rawContextTokens": 182 }
      ...
      expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
        ...
        [emit] agent.status.updated        { "contextTokens": 166, "rawContextTokens": 187 }
        ...
        [emit] agent.status.updated        { "contextTokens": 166, "rawContextTokens": 166 }
        ...
        [emit] agent.status.updated        { "contextTokens": 178, "rawContextTokens": 190 }
        ...
        [emit] agent.status.updated        { "contextTokens": 178, "rawContextTokens": 178 }
    ...
    `);
      ...
      expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
        ...
        [emit] agent.status.updated         { "contextTokens": 189, "rawContextTokens": 192 }
        ...
        [wire] llm.request                  { "kind": "loop", "provider": "kimi", "model": "mock-model", "modelAlias": "mock-model", "thinkingEffort": "off", "maxTokens": 999811, "toolSelect": false, "systemPromptHash": "ec9c34379c88babbc468ef2f3e0e08cd2f422c8c4a910664fb8bb394d703a575", "toolsHash": "e1c03bebb1298f76f76913ceac4f165154dcac73691b41c958927104c5a87dbf", "messageCount": 6, "turnStep": "1.1", "time": "<time>" }
        ...
        [emit] agent.status.updated         { "contextTokens": 197, "rawContextTokens": 208 }
        ...
        [emit] agent.status.updated         { "contextTokens": 197, "rawContextTokens": 197 }
