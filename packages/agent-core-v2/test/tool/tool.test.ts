  ...
  describe('registered user tools', () => {
    ...
    it('routes registered user tools through tool.call request/response', async () => {
      ...
      expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
        ...
        [wire] context.append_loop_event   { "event": { "type": "step.end", "uuid": "<uuid-1>", "turnId": "0", "step": 1, "finishReason": "tool_use", "usage": { "inputOther": 87, "output": 21, "inputCacheRead": 0, "inputCacheCreation": 0 }, "messageId": "mock-1" }, "time": "<time>" }
        ...
        [emit] turn.step.completed         { "turnId": 0, "step": 1, "stepId": "<uuid-1>", "usage": { "inputOther": 87, "output": 21, "inputCacheRead": 0, "inputCacheCreation": 0 }, "finishReason": "tool_calls" }
        ...
        [wire] context.append_loop_event   { "event": { "type": "step.end", "uuid": "<uuid-4>", "turnId": "0", "step": 2, "finishReason": "end_turn", "usage": { "inputOther": 113, "output": 12, "inputCacheRead": 0, "inputCacheCreation": 0 }, "messageId": "mock-2" }, "time": "<time>" }
        ...
        [emit] turn.step.completed         { "turnId": 0, "step": 2, "stepId": "<uuid-4>", "usage": { "inputOther": 113, "output": 12, "inputCacheRead": 0, "inputCacheCreation": 0 }, "finishReason": "completed" }
    ...
    `);
      ...
      expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
        ...
        [wire] context.append_loop_event    { "event": { "type": "step.end", "uuid": "<uuid-6>", "turnId": "1", "step": 1, "finishReason": "end_turn", "usage": { "inputOther": 133, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 }, "messageId": "mock-3" }, "time": "<time>" }
        ...
        [emit] turn.step.completed          { "turnId": 1, "step": 1, "stepId": "<uuid-6>", "usage": { "inputOther": 133, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 }, "finishReason": "completed" }
